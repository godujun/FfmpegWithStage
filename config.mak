...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --cpu=armv7-a --sysroot=/Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm --disable-avdevice --disable-decoder=h264 --disable-decoder=h264_vdpau --enable-libstagefright-h264 --prefix=../build/stagefright/armeabi-v7a --extra-cflags='-I../android-source/frameworks/native/include   -I../android-source/frameworks/native/include/media/openmax/  -I../android-source/system/core/include -I../android-source/frameworks/av/include -I../android-source/frameworks/av/media/libstagefright -I../android-source/frameworks/base/include -I../android-source/frameworks/hardware/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon' --extra-ldflags='-Wl,--fix-cortex-a8 -L../android-libs -Wl,-rpath-link,../android-libs -lstagefright  -L/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a -lstdc++ -lutils -lbinder -lgnustl_static -lgnustl_shared ' --extra-cxxflags='-Wno-multichar -fno-exceptions -fno-rtti'
...
ARCH=arm
INTRINSICS=neon
CC=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
CXX=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
AS=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
LD=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-g++
DEPCC=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-ranlib
STRIP=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -isysroot /Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I../android-source/frameworks/native/include -I../android-source/frameworks/native/include/media/openmax/ -I../android-source/system/core/include -I../android-source/frameworks/av/include -I../android-source/frameworks/av/media/libstagefright -I../android-source/frameworks/base/include -I../android-source/frameworks/hardware/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS= -Wno-multichar -fno-exceptions -fno-rtti -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I../android-source/frameworks/native/include -I../android-source/frameworks/native/include/media/openmax/ -I../android-source/system/core/include -I../android-source/frameworks/av/include -I../android-source/frameworks/av/media/libstagefright -I../android-source/frameworks/base/include -I../android-source/frameworks/hardware/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/include -I/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a/include -march=armv7-a -mfloat-abi=softfp -mfpu=neon -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=~/DevelopTool/android-ndk-r10b/toolchains/arm-linux-androideabi-4.8/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -Wl,--fix-cortex-a8 -L../android-libs -Wl,-rpath-link,../android-libs -lstagefright -L/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a -lstdc++ -lutils -lbinder -lgnustl_static -lgnustl_shared --sysroot=/Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -isysroot /Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
#LDFLAGS= -Wl,--fix-cortex-a8 -L../android-libs -Wl,-rpath-link,../android-libs -lstagefright -L/Users/yujun/DevelopTool/android-ndk-r10b/sources/cxx-stl/gnu-libstdc++/4.8/libs/armeabi-v7a -lstdc++ -lutils -lbinder   -lsupc++  -lgnustl_static -lstl -lstlport --sysroot=/Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -isysroot /Users/yujun/DevelopTool/android-ndk-r10b/platforms/android-9/arch-arm -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
