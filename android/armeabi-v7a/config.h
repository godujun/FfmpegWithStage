...
#define FFMPEG_CONFIGURATION "--disable-shared --enable-static --disable-devices --enable-avresample --disable-mmx --disable-yasm"
...
#define ARCH_ALPHA 0
#ifdef ARCH_ARMn#undef ARCH_ARMn#endifn#define ARCH_ARM 1
#define ARCH_AVR32 0
...
#define ARCH_IA64 0
#define ARCH_M68K 0
#ifdef ARCH_MIPSn#undef ARCH_MIPSn#endifn#define ARCH_MIPS 0
...
#define ARCH_TOMI 0
#ifdef ARCH_X86n#undef ARCH_X86n#endifn#define ARCH_X86 0
#ifdef ARCH_X86_32n#undef ARCH_X86_32n#endifn#define ARCH_X86_32 0
#ifdef ARCH_X86_64n#undef ARCH_X86_64n#endifn#define ARCH_X86_64 0
...
#ifdef HAVE_MALLOC_Hn#undef HAVE_MALLOC_Hn#endifn#define HAVE_MALLOC_H 0
...
#ifdef HAVE_PTHREADSn#undef HAVE_PTHREADSn#endifn#define HAVE_PTHREADS 1
