...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-shared --enable-static --disable-devices --enable-avresample --disable-mmx --disable-yasm
prefix=/usr/local
...
SRC_PATH=/Users/yujun/work/AndroidPlayer-master/jni/ffmpeg
...
CFLAGS=   -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
EXTRALIBS=-framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -liconv -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
